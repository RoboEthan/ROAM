...
// ========= Pi <-> ESP32 UART =========
#define RX_PIN 17      // Pi TX -> ESP32 RX (Was using 17 for rx and 18 for tx if this doesnt work)
...
// New edited normalization
// Normalize |v| so that -256..255 maps to 0..255 linearly
static inline int normalizeMagnitude(long v) {
  long mag = labs(v);
